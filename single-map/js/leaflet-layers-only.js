...
L.Control.Key = L.Control.extend({
    onAdd: function(map) {
        ...
        symbol1.id = 'higher-data-symbol';
        var symbol2 = L.DomUtil.create('div');
        symbol2.className = 'symbol';
        symbol2.id = 'lower-data-symbol';
        ...
        legend1.innerText = 'Larger numbers';
        legend1.className = 'legend';
        var legend2 = L.DomUtil.create('span');
        legend2.innerText = 'Smaller numbers';
        ...
        container1.append(symbol1, legend1);
        container2.append(symbol2, legend2);
        container3.append(symbol3, legend3);
        container4.append(symbol4, legend4);
